...
public class KółkoiKrzyżykdla2 {

    static ArrayList<Integer> pozycjeGracza = new ArrayList<Integer>();
    static ArrayList<Integer> pozycjaGracz2 = new ArrayList<Integer>();
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            while(pozycjeGracza.contains(pozycjaGracz) || pozycjaGracz2.contains(pozycjaGracz)) {
            ...
            System.out.println("Wypisz gdzie chcesz ustawić 0 (1-9): ");
            int pozycjaGracza2 = scanner.nextInt();

            while(pozycjeGracza.contains(pozycjaGracz2) || pozycjaGracz2.contains(pozycjaGracz)) {
                System.out.println("Tam jest zajęte!!!");
                System.out.println("Wypisz gdzie chcesz ustawić 0 (1-9): ");
                pozycjaGracza2 = scanner.nextInt();
            }
            ustawPionek(planszaGry, pozycjaGracza2, "Gracz 2");
    ...
    public static void ustawPionek(char [] [] planszaGry, int pozycja, String user) {
        ...
        }else if (user.equals("Gracz2")) {
            symbol = '0';
            pozycjaGracz2.add(pozycja);
        }
    ...
    public static String sprawdzWygrana() {
        ...
        for(List lista : czyWygrana) {
            if (pozycjeGracza.containsAll(lista)) {
                return "Wygrałeś";
            } else if (pozycjaGracz2.containsAll(lista)) {
                return "Przegrałeś";
            } else if (pozycjeGracza.size() + pozycjaGracz2.size() == 9 ) {
                return "REMIS";
            }
        }
